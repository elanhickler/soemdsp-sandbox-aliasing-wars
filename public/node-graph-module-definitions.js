const nodeGraphNodeLabels = Object.freeze({
  ...
  tubeOscillator: "Tube Oscillator",
...
const nodeGraphModuleDefinitions = Object.freeze({
  ...
  hackettShapes: {
    ...
    parameters: [
      {
        choices: ["Spiral Sphere", "Ring Sphere", "Electric Grid Cube", "Dotted Cube", "Dotted Cube (Dimensional)"],
        defaultValue: "0",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "shape",
      ...
      { key: "speed", label: "Speed", defaultValue: "1", min: "-8", mid: "1", max: "8", step: "0.01" },
      { key: "a", label: "A", defaultValue: "1", min: "0.1", mid: "3", max: "10", step: "0.01" },
      { key: "b", label: "B", defaultValue: "3", min: "0.1", mid: "3", max: "10", step: "0.01" },
      { key: "level", label: "Level", defaultValue: "1", min: "0", mid: "0.5", max: "1", step: "0.01" },
    ],
  },
  lorenzAttractor: {
  ...
  dsfOscillator: {
    ...
    parameters: [
      {
        choices: ["Sine", "Saw", "Square (PWM)", "Trimorph", "SquSaw", "Quasi Saw", "Quasi Square", "Walter's Saw"],
        defaultValue: "1",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "waveform",
  ...
  tubeOscillator: {
    ...
    parameters: [
      {
        choices: ["Analog Saw (Sine)", "Analog Saw (Parabol)", "Perfect Saw", "Analog Square", "Square", "Tri", "Bow Tri", "Distorted Bow Tri", "Walter Wave", "Parabol Sine"],
        defaultValue: "0",
        displayChoices: true,
        divideChoicesVisibly: true,
        key: "waveform",
